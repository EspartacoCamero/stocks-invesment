...
def get_stock_data(stock, start_date, end_date, col='Close'):
    # yfinance devuelve un DataFrame directamente
    df = yfin.download(stock, start=start_date, end=end_date, progress=False)
    return df[col]
